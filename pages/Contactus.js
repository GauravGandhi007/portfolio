...
const Contactus = () => {
  function formSubmit(e) {
    ...
    fetch("https://getform.io/f/368c1a96-6dde-4385-b3b5-2e599cbc8787", {
      method: "POST",
      body: formData,
      headers: {
        ...
        <div className="flex flex-col  space-y-5  ">
          ...
          <p>Front-End Developer</p> */}
            ...
            <div className="flex space-x-8 pb-5 flex-row">
              <Buttonrounded
                link={"https://www.linkedin.com/in/gaurav-gandhi-b0a797248"}
                title={"Linkedin"}
              >
                <FaLinkedinIn color="white" size={25} />
              </Buttonrounded>
              <Buttonrounded
                link={"https://github.com/GauravGandhi007"}
                title={"Github"}
              >
              ...
              <Buttonrounded
                link={
                  "https://drive.google.com/file/d/1tVrQEWO2NGcc2fxYFhBbPWhljOd9L5HL/view?usp=sharing"
                }
                title={"Resume"}
              >
              ...
              <Buttonrounded
                link={"https://api.whatsapp.com/send?phone=918299507506"}
                title={"Whatsapp"}
              >
